...
class MangerController extends Controller
{
    public function __construct(private ManagerService $service)
    {
        ...
        $this->middleware('check_permission:managers-create')->only('create','store');
        $this->middleware('check_permission:managers-update')->only('edit','update','toggle');
        $this->middleware('check_permission:managers-delete')->only('destroy');;
    }
