...
class RoleController extends Controller
{
    public function __construct(private RoleService $service)
    {
        ...
        $this->middleware('check_permission:roles-create')->only('create','store');
        $this->middleware('check_permission:roles-update')->only('edit','update');
        $this->middleware('check_permission:roles-delete')->only('destroy');
    }
