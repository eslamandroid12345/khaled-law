...
@section('title', __('dashboard.Create') . ' ' . __('dashboard.services'))
                    ...
                    <div class="card">
                        <form action="{{ route('services.store') }}" method="post" autocomplete="off"
                            ...
                            <div class="card-header">
                                <h3 class="card-title">@lang('dashboard.Create') @lang('dashboard.services')</h3>
                            </div>
                            <div class="card-body">
                                @csrf
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="desc_ar" class="form-control summernote" id="exampleInputName1"  placeholder="@lang('dashboard.Review Ar')" ></textarea>
                                        </div>
                                    </div>
                                    @error('desc_ar')
                                    <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="desc_en" class="form-control summernote" id="exampleInputName1"  placeholder="@lang('dashboard.Review En')" ></textarea>
                                        </div>
                                    </div>
                                    @error('desc_en')
                                    <div class="text-danger">{{ $message }}</div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="required_files_ar" class="form-control summernote" id="exampleInputName1"  placeholder="@lang('dashboard.Review Ar')" ></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="required_files_en" class="form-control summernote" id="exampleInputName1"  placeholder="@lang('dashboard.Review En')" ></textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="price" type="number" class="form-control"  id="exampleInputName1" value="{{ old('price') }}" placeholder="@lang('dashboard.price')" >
                                        </div>
                                    </div>
                                    @error('price')
                                    <div class="text-danger">{{ $message }}</div>
