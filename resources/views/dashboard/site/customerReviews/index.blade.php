...
@endphp
@section('title', __('dashboard.customer-review'))
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">@lang('dashboard.customer-review')</h3>
                            <div class="card-tools">
                                @permission('customer-review-create')
                        ...
                        <div class="card-body">
                            <form action="{{route('customer-reviews.index')}}">
                                <div class="row">
                                    ...
                                    <div class="form-group col-3">
                                        ...
                                        <a href="{{route('customer-reviews.index')}}" style="color: #fff" class="btn btn-dark waves-effect waves-light"><i class="fa fa-spinner"></i> </a>
                                    </div>
                                </div>
                            </form>
                            ...
                            <table class="table table-bordered">
                                ...
                                @forelse($customerReviews as $customerReview)
                                    <tr>
                                        ...
                                        <td>{{ $customerReview->t('name') }}</td>
                                        <td>{{ $customerReview->t('review') }}</td>
                                        <td><img src="{{ !is_null($customerReview->image) ? url($customerReview->image->image_url) : '' }}" style="width: 100px;" /></td>
                                      <td>
                                            <div class="operations-btns" style="">
                                                @permission('customer-review-update')
                                                <a href="{{ route('customer-reviews.edit', $customerReview->id) }}"
                                                   class="btn  btn-dark">@lang('dashboard.Edit')</a>
                                                @endpermission
{{--                                                <a href="{{ route('services.show', $service->id) }}"--}}
{{--                                                   class="btn  btn-dark">@lang('dashboard.Show')</a>--}}
                                                @permission('customer-review-delete')
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content float-left">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('customer-reviews.destroy', $customerReview->id) }}"
                                                                        method="post">
                                                                        @csrf
                                                                        {{ method_field('delete') }}
                                                                        <button type="submit"
                        ...
                        <div class="card-footer">
                            {{ $customerReviews->appends(['search' => request()->search])->links() }}
                        </div>
                    </div>
                    <!-- /.card -->
                </div>
