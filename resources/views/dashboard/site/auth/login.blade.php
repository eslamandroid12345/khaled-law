...
<head>
    ...
    <title>@lang('dashboard.khaled') | @lang('dashboard.Dashboard') | @lang('titles.Login')</title>
...
<div class="login-box">
    <div class="login-logo">
        <a href="{{ route('/') }}">@lang('dashboard.khaled') @lang('dashboard.Dashboard')</a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
        <div class="card-body login-card-body">
            ...
            <form action="{{ route('auth.login') }}" method="post">
                ...
                <div class="input-group mb-3">
                    <input name="password" type="password" class="form-control" placeholder="@lang('dashboard.Password')" id="password">
                    <div class="input-group-append">
                        {{-- <div class="input-group-text">
